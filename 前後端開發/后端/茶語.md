...
> ## 罯屑回收根節點 GC Roots
> 
> 可達性就是一種搜索，搜索的起點就是這個根節點，，它們是一組必須存活的絕對可靠的引用，
> 
> ### 選取
> - 虛擬機棧或者本地方法棧引用的對象
> - 靜態成員引用的對象：`private static Object staticObject = new Object();`
> - 常量引用的對象：`private static final String CONSTANT_STRING = "I am a constant";`
> 
> #### 測試4
> 
> ##### 測試5
